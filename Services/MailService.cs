...
class MailService : IMailService
{
    ...
    {
        var frontendHost = _configuration.GetSection("Client")["Host"];
        var mailTask = new MailTask
        {
            recipient = submission.emailAddress,
            subject = "Confirm ReverseDock Submission",
            bodyHTML = @$"
                                      ...
                                      <tbody>
                                        <tr>
                                          <td style=""line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;"" align=""left"">
                                            <h1 class=""h3"" style=""padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;"" align=""left"">ReverseDock submission pending</h1>
                                            ...
                                            <div class=""space-y-3"">
                                              <p class=""text-gray-700"" style=""line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;"" align=""left"">Dear ReverseDock user,</p>
                                              ...
                                              <p class=""text-gray-700"" style=""line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;"" align=""left"">
                                                please <b>confirm</b> your submission by clicking on the following link: <a href=""{frontendHost}/confirm?id={submission.guid}&confirmationId={submission.confirmationGuid}"" target=""_blank"" style=""color: #0d6efd;"">Confirm submission</a>.
                                              </p>
                                            </div>
                                            <table class=""s-5 w-full"" role=""presentation"" border=""0"" cellpadding=""0"" cellspacing=""0"" style=""width: 100%;"" width=""100%"">
                                              <tbody>
...
,
            bodyRaw = $@"
             Dear ReverseDock user,
             please confirm your submission by opening the following link: {frontendHost}/confirm?id={submission.guid}&confirmationId={submission.confirmationGuid}
            "
        };
    ...
    public async Task PublishConfirmedMail(Submission submission)
    {
        ...
        {
            recipient = submission.emailAddress,
            subject = "ReverseDock Submission Confirmed",
            bodyHTML = $@"
<!DOCTYPE html PUBLIC ""-//W3C//DTD XHTML 1.0 Strict//EN"" ""http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"">
<html>
  <head>
  ...
  <body class=""bg-light"" style=""outline: 0; width: 100%; min-width: 100%; height: 100%; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; font-family: Helvetica, Arial, sans-serif; line-height: 24px; font-weight: normal; font-size: 16px; -moz-box-sizing: border-box; -webkit-box-sizing: border-box; box-sizing: border-box; color: #000000; margin: 0; padding: 0; border-width: 0;"" bgcolor=""#f7fafc"">
      ...
      <tbody>
        <tr>
          <td valign=""top"" style=""line-height: 24px; font-size: 16px; margin: 0;"" align=""left"" bgcolor=""#f7fafc"">
                                  ...
                                  <td style=""line-height: 24px; font-size: 16px; width: 100%; margin: 0;"" align=""left"" bgcolor=""#ffffff"">
                                    <table class=""card-body"" role=""presentation"" border=""0"" cellpadding=""0"" cellspacing=""0"" style=""width: 100%;"">
                                      <tbody>
                                        <tr>
                                          <td style=""line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;"" align=""left"">
                                            <h1 class=""h3"" style=""padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;"" align=""left"">ReverseDock submission confirmed</h1>
                                            <table class=""s-2 w-full"" role=""presentation"" border=""0"" cellpadding=""0"" cellspacing=""0"" style=""width: 100%;"" width=""100%"">
                                              <tbody>
                                                <tr>
                                                  <td style=""line-height: 8px; font-size: 8px; width: 100%; height: 8px; margin: 0;"" align=""left"" width=""100%"" height=""8"">
                                            ...
                                            <div class=""space-y-3"">
                                              ...
                                              <p class=""text-gray-700"" style=""line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;"" align=""left"">
                                                your submission has been confirmed. You can check its status and intermediate results at the following link: <a href=""{frontendHost}/info?id={submission.guid}"" target=""_blank"" style=""color: #0d6efd;"">Results</a>.
                                              </p>
                                            </div>
                                            <table class=""s-5 w-full"" role=""presentation"" border=""0"" cellpadding=""0"" cellspacing=""0"" style=""width: 100%;"" width=""100%"">
                                              <tbody>
            ...
            bodyRaw = $@"
             Dear ReverseDock user,
             thank you for confirming your submission. You can check your results at the following link: {frontendHost}/info?id={submission.guid}
            "
        };
    ...
    public async Task PublishFinishedMail(Submission submission)
    {
        ...
        {
            recipient = submission.emailAddress,
            subject = "ReverseDock Submission Finished",
            bodyHTML = $@"
<!DOCTYPE html PUBLIC ""-//W3C//DTD XHTML 1.0 Strict//EN"" ""http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"">
<html>
  <head>
      ...
      <tbody>
        <tr>
          <td valign=""top"" style=""line-height: 24px; font-size: 16px; margin: 0;"" align=""left"" bgcolor=""#f7fafc"">
                                  ...
                                  <td style=""line-height: 24px; font-size: 16px; width: 100%; margin: 0;"" align=""left"" bgcolor=""#ffffff"">
                                    <table class=""card-body"" role=""presentation"" border=""0"" cellpadding=""0"" cellspacing=""0"" style=""width: 100%;"">
                                      <tbody>
                                        <tr>
                                          <td style=""line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;"" align=""left"">
                                            <h1 class=""h3"" style=""padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;"" align=""left"">ReverseDock submission finished</h1>
                                            <table class=""s-2 w-full"" role=""presentation"" border=""0"" cellpadding=""0"" cellspacing=""0"" style=""width: 100%;"" width=""100%"">
                                              <tbody>
                                                <tr>
                                                  <td style=""line-height: 8px; font-size: 8px; width: 100%; height: 8px; margin: 0;"" align=""left"" width=""100%"" height=""8"">
                                            ...
                                            <div class=""space-y-3"">
                                              ...
                                              <p class=""text-gray-700"" style=""line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;"" align=""left"">
                                                your submission has finished calculating. You can check the results at the following link: <a href=""{frontendHost}/info?id={submission.guid}"" target=""_blank"" style=""color: #0d6efd;"">Results</a>.
                                              </p>
                                            </div>
                                            <table class=""s-5 w-full"" role=""presentation"" border=""0"" cellpadding=""0"" cellspacing=""0"" style=""width: 100%;"" width=""100%"">
                                              <tbody>
            ...
            bodyRaw = $@"
             Dear ReverseDock user,
             Your submission has finished. You can check your results at the following link: {frontendHost}/info?id={submission.guid}
            "
        };
